...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <a class="navbar-brand" href="#">RSP-PharmaCompany</a>
  ...
  <div class="container mt-5">
    <div class="row">
      <div class="col-md-8">
        <h1>Welcome to RSP-PharmaCompany</h1>
        <p>Welcome to RSP-PharmaCompany, your trusted source for high-quality pharmaceutical products. We are dedicated to improving the health and well-being of our customers by providing safe and effective medications.</p>
        ...
        <p>Thank you for choosing RSP-PharmaCompany for your healthcare needs. We look forward to serving you and helping you live a healthier life.</p>
      </div>
      <div class="col-md-4">
        <img src="Pharmaceutical-Companies.jpg" class="img-fluid" alt="Pharmacy Image">
      </div>
    </div>
  </div>
  ...
  <footer class="bg-dark text-white text-center">
    <div class="container">
      <p>&copy; @2024 RSP PharmaCompany... BY ROOP SAGAR S L(212223040175)</p>
    </div>
  </footer>
  ...
  <div class="container mt-5 content">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="card-deck">
          <div class="card">
            <img src="Dolo-650-tablets.jpg" class="card-img-top" alt="Product 1" width="200" height="200">
            <div class="card-body">
              <h5 class="card-title">DOLO-650</h5>
              <p class="card-text">It can provide relief from these symptoms and help manage pain and fever.</p>
              <a href="#" class="btn btn-primary">Buy Now</a>
            </div>
          </div>
          <div class="card">
            <img src="CETIRIZINE_10mg.jpg" class="card-img-top" alt="Product 2" width="200" height="200">
            <div class="card-body">
              <h5 class="card-title">CETIRIZINE-500mg</h5>
              <p class="card-text">Cetrizine Tablet belongs to a group of medicines called antihistamines. It is used to treat various allergic conditions such as hay fever, conjunctivitis and etc...</p>
              <a href="#" class="btn btn-primary">Buy Now</a>
            </div>
          </div>
          <div class="card">
            <img src="paracetamol.webp" class="card-img-top" alt="Product 3" width="200" height="200">
            <div class="card-body">
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <address>
          ...
          68-ajoop street,ph-road<br>
          Chennai-600077<br><br>
          <strong>Email:</strong><br>
          RSPpharma@gmail.com<br><br>
...
![alt text](<Screenshot 2024-05-11 192142.png>)

![alt text](<Screenshot 2024-05-11 192204.png>)

![alt text](<Screenshot 2024-05-11 192215.png>)

![alt text](<Screenshot 2024-05-11 192253.png>)
